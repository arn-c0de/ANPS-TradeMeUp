@echo off
REM Wrapper for MVP Pipeline - Keeps terminal open on errors
REM Called by GUI to start MVP pipeline in separate console
...
echo Script: %CD%\scripts\run_mvp_pipeline.py
echo Working Dir: %CD%
echo Arguments: %*
echo.
...
"%CD%\venv\Scripts\python.exe" "%CD%\scripts\run_mvp_pipeline.py" %*
