...
class ChartDataManager:
    ...
    def _get_cache_key(self, symbol: str, timeframe: str, start_date: Optional[datetime] = None, end_date: Optional[datetime] = None) -> str:
    ...
    def get_initial_data(self, symbol: str, timeframe: str) -> Optional[pd.DataFrame]:
        """
    ...
    def load_more_future(self, symbol: str, timeframe: str, current_latest_date: datetime) -> Optional[pd.DataFrame]:
        """
    ...
    def load_more_historical(self, symbol: str, timeframe: str, current_earliest_date: datetime) -> Optional[pd.DataFrame]:
        """
...
_chart_data_manager: Optional[ChartDataManager] = None
