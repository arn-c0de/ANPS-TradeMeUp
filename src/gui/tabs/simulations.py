...
def create_layout():
    ...
    return html.Div([
        ...
        dbc.Container([
            # Create New Simulations Section
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardHeader(html.Small("➕ Create New Simulations"), className="py-1"),
                        dbc.CardBody([
                            dbc.Row([
                                dbc.Col([
                                    html.Small("Entities", className="text-muted d-block"),
                                    dcc.Dropdown(
                                ...
                                dbc.Col([
                                    html.Small("Limit", className="text-muted d-block"),
                                    dcc.Input(
                                        id="create-sim-limit",
                                        type="number",
                                        value=50,
